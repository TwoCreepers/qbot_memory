...
namespace memory::exception
{
	...
	{
	public:
		runtime_error(const char* msg = "未知运行时错误", const char* name = "运行时错误") : exception(msg, name) {}
		runtime_error(std::string msg, const char* name = "运行时错误") : exception(std::move(msg), name) {}
	...
	{
	public:
		bad_exception(const char* msg = "未知错误异常", const char* name = "错误异常") : runtime_error(msg, name) {}
		bad_exception(std::string msg, const char* name = "错误异常") : runtime_error(std::move(msg), name) {}
	...
	{
	public:
		bad_function_call(const char* msg = "调用了错误的函数", const char* name = "函数调用异常") : bad_exception(msg, name) {}
		bad_function_call(std::string msg, const char* name = "函数调用异常") : bad_exception(std::move(msg), name) {}
	...
	{
	public:
		bad_stmt(const char* msg = "错误的语句", const char* name = "预编译SQL语句异常") : bad_exception(msg, name) {}
		bad_stmt(std::string msg, const char* name = "预编译SQL语句异常") : bad_exception(std::move(msg), name) {}
	...
	{
	public:
		bad_transaction(const char* msg = "错误的事务", const char* name = "事务错误") : bad_exception(msg, name) {}
		bad_transaction(std::string msg, const char* name = "事务错误") : bad_exception(std::move(msg), name) {}
	...
	{
	public:
		bad_database(const char* msg = "数据库错误", const char* name = "数据库错误") : bad_exception(msg, name) {}
		bad_database(std::string msg, const char* name = "数据库错误") : bad_exception(std::move(msg), name) {}
	...
	{
	public:
		sqlite_call_error(const char* msg = "SQLite调用错误", const char* name = "SQLite调用错误") : bad_database(msg, name) {}
		sqlite_call_error(std::string msg, const char* name = "SQLite调用错误") : bad_database(std::move(msg), name) {}
	...
	{
	public:
		sqlite_extension_error(const char* msg = "未知SQLite扩展异常", const char* name = "SQLite扩展异常")
			: sqlite_call_error(msg, name)
		{
		}
		sqlite_extension_error(std::string msg, const char* name = "SQLite扩展异常") : sqlite_call_error(std::move(msg), name) {}
	...
	{
	public:
		length_error(const char* msg = "长度错误", const char* name = "长度异常") : bad_exception(msg, name) {}
		length_error(std::string msg, const char* name = "长度异常") : bad_exception(std::move(msg), name) {}
	...
	{
	public:
		out_of_range(const char* msg = "超出有效范围", const char* name = "范围异常") : bad_exception(msg, name) {}
		out_of_range(std::string msg, const char* name = "范围异常") : bad_exception(std::move(msg), name) {}
	...
	public:
		...
		bad_alloc(std::string msg, const char* name = "内存分配异常") : bad_exception(std::move(msg), name) {}
